/**
 * Original source code by halfluck from the RaspberryPi Forums:
 * https://www.raspberrypi.org/forums/viewtopic.php?t=53680&p=860627
 *
 * Only minimal modifications made.
 *
 * Compile using gcc, chmod +x and place in /usr/bin or similar.
